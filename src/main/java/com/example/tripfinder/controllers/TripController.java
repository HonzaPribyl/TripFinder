...
public class TripController {
    ...
    public List<TripDTO> search(
            ...
            @RequestParam final List<Long> highPrefAirports,
            @RequestParam final List<Long> prefAirports,
            @RequestParam final List<Long> highPrefLocs,
            @RequestParam final List<Long> prefLocs,
